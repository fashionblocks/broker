...
contract GenArt721Core is CustomERC721Metadata {
    ...
    function mint(address to, uint256 projectId) public returns (uint256 _tokenId) {
...
//        require(!projects[_projectId].paused || _by == projectIdToArtistAddress[_projectId], "Purchases are paused.");
        ...
        uint256 tokenId = _mintToken(to, projectId);
...
//
    ...
    function addProject(string memory _projectName, address _artistAddress, string memory _website, string memory _description, uint256 _pricePerTokenInWei, bool _dynamic) public onlyWhitelisted {
...
//    }
//
    function projectDetails(uint256 _projectId) view public returns (string memory projectName, address artist, string memory description, string memory website, string memory license, bool dynamic) {
        projectName = projects[_projectId].name;
//        artist = projects[_projectId].artist;
        artist = projectIdToArtistAddress[_projectId];
